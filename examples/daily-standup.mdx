...
1. We'll get a [Discord webhook URL](https://support.discord.com/hc/en-us/articles/228383668-Intro-to-Webhooks).
2. We'll to use a [cron expression](https://crontab.guru/) to schedule a standup prompt to be sent to Discord every morning at 9am, Monday through Friday.
