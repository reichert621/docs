...
We'll use the [cheerio](TODO) library to parse the essay page HTML. Here's what that function might look like:
...
You may have noticed that we added a special key to our response body: `$set`
